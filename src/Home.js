    ...
    return (
        <div className="home">
            ...
            <div className="home__row">
                ...
                {/* Product */}
                {/* Product */}
                <Product id="1345" title="HP Pavilion Gaming DK0268TX 15.6-inch Laptop (Core i5-9300H/8GB/512GB SSD/Windows 10 Home/4GB NVIDIA GeForce GTX 1650 Graphics), Shadow Black" price={69900} image="https://m.media-amazon.com/images/I/41Hxk3Dl5RL.__AC_SY200_.jpg" rating={3} />
